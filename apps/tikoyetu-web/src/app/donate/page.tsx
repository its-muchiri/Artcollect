    ...
    <>
      ...
      <main>
        <section className="mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-16 text-center">
          ...
          <h1 className="mt-6 max-w-3xl font-display text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl">
              ...
              {causes.map((cause) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col gap-3 p-5">
                    ...
                    <p className="line-clamp-2 text-sm text-zinc-500">{cause.summary}</p>
                    ...
                    <div className="mt-auto pt-2">
                      <div className="flex items-baseline justify-between text-sm">
                        <span className="font-semibold text-zinc-900">
                          {formatMoney(cause.raisedMinor, cause.currency)}
                        </span>
                        <span className="text-zinc-400">
                          of {formatMoney(cause.goalMinor, cause.currency)}
                        </span>
                      </div>
